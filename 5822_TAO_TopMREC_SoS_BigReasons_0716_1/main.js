...
//tickclock
.from("#clockmask", .5, {autoAlpha:0, scale:"0%", transformOrigin: "40px", ease: Back.easeOut.config(2)})
.from("circle", 1.5, {drawSVG:"0%"})
.to(".circ", 0.3, {autoAlpha:0})
.from("#tick", .5, {scale:"0%", ease: Back.easeOut.config(2)}, "-=0.3") 
.from(".redtab", .5, {left:"-129px", ease: Back.easeOut.config(1)}, "shift")
.to("#clockmask", .5, {left:"44px", ease: Back.easeOut.config(1)}, "shift")
.from(".clockdisclaim", .3, {autoAlpha:0})

.addLabel("fade2")
.to("#clockmask", .5, {autoAlpha:0, scale:"0%", ease: Back.easeOut.config(2)}, "fade2+=3")
.to(".clockdisclaim", .3, {autoAlpha:0}, "fade2+=3")
